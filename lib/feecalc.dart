...
import 'planecalc.dart';

class feecalc extends StatefulWidget {
  const feecalc({super.key});

  @override
  State<feecalc> createState() => _feecalc();
}

class _feecalc extends State<feecalc> {
  @override
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const planecalc(),
                        ),
                      );
                    },
                    child: Container(
