...
class planeSchedule extends StatefulWidget {
  const planeSchedule({super.key});

  @override
  State<planeSchedule> createState() => _planeScheduleState();
}

class _planeScheduleState extends State<planeSchedule> {
  @override
